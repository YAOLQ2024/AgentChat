...
<p align="center">
  <a href="https://github.com/YAOLQ2024/AgenChat">Repository</a> •
  <a href="https://github.com/YAOLQ2024/AgenChat/blob/main/docker/README.md">Deployment Guide</a> •
  <a href="https://github.com/YAOLQ2024/AgenChat/tree/main/docs">Documentation</a> •
  <span>Live Demo (Coming Soon)</span> •
  <a href="https://github.com/YAOLQ2024/AgenChat/issues">Issue Tracker</a> •
  <a href="https://github.com/YAOLQ2024/AgenChat/discussions">Discussions</a>
</p>
...
```bash
# 1. Clone the project
git clone https://github.com/YAOLQ2024/AgenChat.git
cd AgenChat
...
*Current maintainer: huiqian.xiao (GitHub: YAOLQ2024)*

<picture>
  <source
    media="(prefers-color-scheme: dark)"
    srcset="
      https://api.star-history.com/svg?repos=YAOLQ2024/AgenChat&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://api.star-history.com/svg?repos=YAOLQ2024/AgenChat&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://api.star-history.com/svg?repos=YAOLQ2024/AgenChat&type=Date"
  />
</picture>
